...
export const HERO_AGENTS_MD = `# Pamela

- Project owner: Pamela
- Replace all references to "my cool project" with "Pamela".
- Keep docs in sync with this hero block content.
- Run \`pnpm lint\` and \`pnpm test\` before merging.`;
